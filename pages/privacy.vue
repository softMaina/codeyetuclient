    ...
    <v-row>
      <v-col cols="12">
        <div class="thin-poppins">
          ...
          This SERVICE is provided by Afrolytix Limited at no cost to the users (referrers) and is intended for use as
          is.
          ...
          accessible at CodeYetu unless otherwise defined in this Privacy Policy.
    ...
    <v-row>
      <v-col cols="12">
        <div class="thin-poppins">
          ...
          identifiable information, including but not limited to Username, password, email address, social media,
          telephone number. The information that we request will be retained by us and used as described in this privacy
          policy.
          The platform does use third party services that may collect information used to identify you.
          Link to privacy policy of third party service providers used by the platform
          • Facebook
          • Twitter
          • Gmail
          • Linkedin
    ...
    <v-row>
      <v-col cols="12">
        <div class="thin-poppins">
          ...
          We want to inform you that whenever you use our Service, in a case of an error in the platform we collect data
          and information (through third party products) on your device called Log Data. This Log Data may include
          information such as your device Internet Protocol (“IP”) address, device name, operating system version, the
          configuration of the platform when utilizing our Service, the time and date of your use of the Service, and
          other statistics.
          Cookies
          ...
          This Service does not use these “cookies” explicitly. However, the platform may use third party code and
          libraries that use “cookies” to collect information and improve their services. You have the option to either
          accept or refuse these cookies and know when a cookie is being sent to your device. If you choose to refuse
    ...
    <v-row>
      <v-col cols="12">
        <div class="thin-poppins">
          ...
          This privacy policy page was created at privacypolicytemplate.net and modified/generated by Platform Privacy
          Policy Generator
